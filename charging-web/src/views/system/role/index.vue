<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Refresh" @click="handleRefreshAuth">刷新数据权限</el-button>
      </el-col>
...
function handleRefreshAuth() {
  proxy.$modal.confirm("是否确认刷新数据权限?").then(() => {
    dataAuthApi.updateOwnerPermission().then((res) => {
