  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="类型" prop="noticeType">
        <el-select v-model="queryParams.noticeType" placeholder="文章类型" clearable style="width: 200px">
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文章标题" align="center" prop="noticeTitle" :show-overflow-tooltip="true" />
      <el-table-column label="文章类型" align="center" prop="noticeType" width="100">
...
const data = reactive({
  ...
  rules: {
    noticeTitle: [{ required: true, message: "文章标题不能为空", trigger: "blur" }],
    noticeType: [{ required: true, message: "文章类型不能为空", trigger: "change" }],
  },
})
